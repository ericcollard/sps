 ...
 */
final class Version20251008073318 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE accomodation CHANGE skiday_id event_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE accomodation CHANGE event_id skiday_id INT NOT NULL');
        $this->addSql('ALTER TABLE accomodation ADD CONSTRAINT FK_520D81B3488BEE0 FOREIGN KEY (skiday_id) REFERENCES skiday (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_520D81B3488BEE0 ON accomodation (skiday_id)');
        $this->addSql('ALTER TABLE skiday ADD accomodation_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE skiday ADD CONSTRAINT FK_8E59D09BFD70509C FOREIGN KEY (accomodation_id) REFERENCES accomodation (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
